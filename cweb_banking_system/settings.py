"""
Django settings for cweb_banking_system project.
...
INSTALLED_APPS = [
    'bank_admin.apps.BankAdminConfig',
...
ROOT_URLCONF = 'cweb_banking_system.urls'
...
WSGI_APPLICATION = 'cweb_banking_system.wsgi.application'
